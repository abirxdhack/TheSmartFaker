...
class Faker:
    ...
    def __init__(self):
        ...
        Scans ``smartfaker/data/*.json`` using :func:`importlib.resources.files`
        and populates the internal ``_data`` mapping. Files that fail JSON
