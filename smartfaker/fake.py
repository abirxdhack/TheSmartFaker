...
class Faker:
    ...
    async def aaddress(
        ...
        worker thread via :func:`asyncio.to_thread` so it never blocks the
        event loop.
        ...
        """
        return await asyncio.to_thread(self.address, country_code, amount, fields, locale)
    ...
    async def aiban(
        ...
        """
        return await asyncio.to_thread(self.iban, country_code, amount)
