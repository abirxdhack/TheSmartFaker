"""Sphinx configuration for SmartFaker documentation."""
...
with open(os.path.abspath("../../smartfaker/__init__.py"), encoding="utf-8") as _f:
...
html_title = f"SmartFaker {version}"
html_theme = "furo"
html_static_path = [os.path.abspath("../../docs_static")]
html_css_files = ["smartfaker.css"]
html_js_files = ["smartfaker_docs.js"]
html_show_sourcelink = False
html_show_copyright = False
html_show_sphinx = False
html_logo = os.path.abspath("../../docs_static/smartfaker.png")
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/abirxdhack/TheSmartFaker",
            "html": (
...
html_baseurl = os.environ.get(
    "READTHEDOCS_CANONICAL_URL", "https://abirxdhack.github.io/TheSmartFaker/"
)
